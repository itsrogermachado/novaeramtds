...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center auth-bg p-4 sm:p-6">
      {/* Background effects */}
      <div className="auth-spotlight" />
      <div className="auth-ambient" />
      <div className="auth-noise" />

      <div className="w-full max-w-[480px] relative z-10 flex flex-col items-center pt-8 sm:pt-12">
