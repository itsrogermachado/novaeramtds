...
import { TutorialLinkInput } from '@/hooks/useTutorials';
import { cn } from '@/lib/utils';

interface TutorialLinksEditorProps {
  links: TutorialLinkInput[];
  onChange: (links: TutorialLinkInput[]) => void;
}

export function TutorialLinksEditor({ links, onChange }: TutorialLinksEditorProps) {
    ...
    <div className="space-y-3">
      ...
      {links.length === 0 && (
        <p className="text-xs text-muted-foreground text-center">
          Adicione links para materiais, recursos ou sites relacionados ao tutorial.
        </p>
      )}
    </div>
  );
